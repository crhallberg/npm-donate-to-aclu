...
describe("Basic tests", function() {
  ...
  valid(
    "valid +gmail address",
    VALID.set("email", "crhallberg+acluapi@gmail.com")
  );
  invalid(
    "invalid email address 1",
    VALID.set("email", "Joe Smith <email@example.com>")
  );
  invalid("invalid email address 2", VALID.set("email", "acluapi"));
  invalid(
    "invalid email address 3",
    VALID.set("email", 'this is"really"notallowed@example.com')
  );
  // Full name extrapolation
  valid(
    "fullname w/o firstname",
    VALID.set("fullname", "Casey Doe").set("firstname", "")
  );
  valid(
    "fullname w/o lastname",
    VALID.set("fullname", "Casey Doe").set("lastname", "")
  );
  valid(
  ...
  invalid(
    "too short fullname",
    VALID.set("fullname", "Casey").set("firstname", "")
  );
  invalid(
    "too long fullname",
    VALID.set("fullname", "Casey Doe Jr.").set("firstname", "")
  );
});
