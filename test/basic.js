...
describe('Basic tests', function() {
  ...
  it('.submit() rejecting correctly', function(done) {
    library.submit( VALID.set('amount', 0).toJS() )
  ...
  invalid('invalid email address 3', VALID.set('email', 'this\ is"really"not\allowed@example.com'));
  ...
  valid('fullname w/o first or last name', VALID.set('fullname', 'Casey Doe').set('firstname', '').set('lastname', ''));
