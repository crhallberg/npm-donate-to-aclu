...
describe('Credit cards', function() {
  describe('Invalid credit cards', function() {
    ...
    invalid('cc_number too long', VALID.set('cc_number', '423456789012345678901'));
  ...
  describe('Credit card types', function() {
    valid('valid numeric cc_number', VALID.set('cc_number', Number(VALID.get('cc_number'))));
    valid('valid string cc_number', VALID.set('cc_number', String(VALID.get('cc_number'))));
    valid('valid numeric CVC', VALID.set('cc_number', Number(VALID.get('cc_number'))));
    valid('valid string CVC', VALID.set('cc_number', String(VALID.get('cc_number'))));
  });
});
